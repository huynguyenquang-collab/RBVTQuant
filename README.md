...
- SqueezeLLM dense-only LUTs are generated by calling
  `SqueezeLLM/quantization/nuq.py::kmeans_fit` directly. Fisher gradients are
  collected locally because the nested SqueezeLLM repository delegates that
  step to the separate SqueezeLLM-gradients project.
