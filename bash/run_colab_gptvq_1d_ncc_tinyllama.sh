...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/gptvq_1d_ncc_tinyllama}"
...
echo "=== GPTVQ-1D vs GPTVQ-1D+NCC TinyLlama Colab benchmark ==="
echo "Model: $MODEL"
echo "Device: $DEVICE"
echo "Output: $OUTPUT_ROOT"
echo "Bits: 4"
echo "NCC budget_p: $NCC_BUDGET_P | sweeps=$NCC_SWEEPS | stop_eps=$NCC_STOP_EPS"
echo "NCC placement: one correction after GPTVQ finishes codebook/assignment optimization"
