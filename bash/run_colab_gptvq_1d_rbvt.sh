...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/gptvq_1d_rbvt_colab}"
...
echo "=== GPTVQ-1D vs GPTVQ-1D+RBVT Colab benchmark ==="
echo "Model: $MODEL"
echo "Device: $DEVICE"
...
echo "Calibration: wikitext2 | n=$N_CALIB | max_length=$MAX_LENGTH"
